# Generated by Django 4.0 on 2021-12-28 07:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('B', 'bronze'), ('S', 'Silver'), ('G', 'Gold')], max_length=88)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'Pending'), ('C', 'Complete'), ('F', 'Failed')], max_length=80)),
            ],
        ),
        migrations.CreateModel(
            name='Promotion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collections', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='collect', to='store.collection')),
        ...
        migrations.AddField(
            model_name='order',
            name='items',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order_item', to='store.orderitem'),
        ),
        migrations.AddField(
            model_name='order',
            name='order',
